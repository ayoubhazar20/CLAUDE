...
const ITEMS: { href: string; label: string; permission?: Permission }[] = [
  ...
  { href: "/settings/integrations/zapier", label: "HubSpot via Zapier", permission: PERMISSIONS.INTEGRATIONS_MANAGE },
  { href: "/settings/integrations/zapier/log", label: "↳ Synchronization log", permission: PERMISSIONS.INTEGRATIONS_MANAGE },
